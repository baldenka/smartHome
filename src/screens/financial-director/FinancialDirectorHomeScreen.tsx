...
const FinancialDirectorHomeScreen = () => {
  ...
  return (
    <ScrollView style={styles.container}>
      <Card style={styles.card}>
        <Card.Content>
          <Title>Личный кабинет финансового директора</Title>
      ...
      <Card style={styles.card}>
        <Card.Content>
          ...
          <Button
            ...
            onPress={() => navigation.navigate('FinancialWorkReportsScreen' as never)}
          ...
          <Button
            mode="contained"
            icon="chart-bar"
            onPress={() => navigation.navigate('FinancialAnalyticsScreen' as never)}
            style={styles.menuButton}
            contentStyle={styles.menuButtonContent}
          >
          ...
          <Button
            mode="contained"
            icon="cash"
            onPress={() => navigation.navigate('BudgetPlanningScreen' as never)}
            style={styles.menuButton}
            contentStyle={styles.menuButtonContent}
          >
...
export default FinancialDirectorHomeScreen;